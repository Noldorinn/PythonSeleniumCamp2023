...
class TestSeleniumtestlogouticon():
  ...
  def test_seleniumtestlogouticon(self):
    ...
    WebDriverWait(self.driver, 0.5).until(expected_conditions.visibility_of_element_located((By.ID, "logout_sidebar_link")))
