...
class TestSeleniumteststandartlogin():
  ...
  def test_seleniumteststandartlogin(self):
    ...
    self.vars["https://www.saucedemo.com/inventory.html"] = self.driver.execute_script("return window.location.href")
