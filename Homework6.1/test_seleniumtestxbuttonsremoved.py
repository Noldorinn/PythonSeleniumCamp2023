...
class TestSeleniumtestxbuttonsremoved():
  ...
  def test_seleniumtestxbuttonsremoved(self):
    ...
    WebDriverWait(self.driver, 0.5).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".form_group:nth-child(2) > .svg-inline--fa")))
    WebDriverWait(self.driver, 0.5).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, ".form_group:nth-child(1) path")))
